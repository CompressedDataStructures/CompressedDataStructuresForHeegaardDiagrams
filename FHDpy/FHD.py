...
class FHDLong:
    ...
    def __init__(self, alpha_curves_standard, alpha_curves_edges, generators_standard, generators_edge):
        ...
        self.alpha = copy.deepcopy(alpha_curves_edges)
        self.generators = copy.deepcopy(generators_standard)
        self.generators_edge = copy.deepcopy(generators_edge)
...
def get_compressed(word):
    ...
    while i < len(word):
        ...
        else: # If the current character has nothing to do with the previous one, simply append it and make it the new last character.
